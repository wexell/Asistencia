...
namespace Asistencia
{
    public partial class Codigo : Form
    {
        ...
        private void Buscar_Empleado(string valor)
        {
            //Conexion
            ...
            //Crear Consulta 
            String CadenaSql = ("EXEC Asistencia.[DBO].[BuscarEmpleado] '" + valor + "'");
